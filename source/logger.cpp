 ...
 *
 * This file implements the logging functionality for the lds library
...
namespace lds {
    ...
    auto make_file_logger() noexcept -> std::shared_ptr<spdlog::logger> {
        auto l = spdlog::basic_logger_mt("file_logger", "lds.log");
     ...
     *
     * This function creates a file logger that writes to "lds.log",
    ...
    void log_with_spdlog(const std::string& message) {
        ...
        spdlog::info("Lds message: {}", message);
    }
