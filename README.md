...
- Replace all occurrences of "LDSCpp" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `LDSCpp` means the name of the project, while `lds` is used in file names.
