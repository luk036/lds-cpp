[![Actions Status](https://github.com/luk036/lds-cpp/workflows/MacOS/badge.svg)](https://github.com/luk036/lds-cpp/actions)
...
- Automatic [documentation](https://thelartians.github.io/lds-cpp) and deployment with [Doxygen](https://www.doxygen.nl) and [GitHub Pages](https://pages.github.com)
...
The documentation is automatically built and [published](https://thelartians.github.io/lds-cpp) whenever a [GitHub Release](https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository) is created.
